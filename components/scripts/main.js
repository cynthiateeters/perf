...
function getNoun(y) {
    ...
    case 'animals':
        var animals = ['flamingo', 'hedgehog', 'owl', 'elephant', 'pussycat',
            ...
            'skunk', 'goat', 'rooster', 'fox', 'porcupine', 'llama', 'grasshopper',
    ...
    case 'music':
        var music = ['violin', 'flute', 'bagpipe', 'guitar', 'symphony',
            ...
            'marimbas', 'bells', 'timpani', 'bongos', 'clarinet', 'recorder', 'oboe', 'conductor',
            'singer'
        ];
        return music;
    case 'horror':
    ...
    case 'places':
        var places = ['swamp', 'graveyard', 'cemetery', 'park', 'building',
            'house', 'river', 'ocean', 'sea', 'field', 'forest', 'woods', 'neighborhood',
            'city', 'town', 'suburb', 'country', 'meadow', 'cliffs', 'lake',
            'stream', 'creek', 'school', 'college', 'university', 'library', 'bakery',
...
]; // types of adjectives for pizza titles (fixed noise-->noisy)
...
document.addEventListener('DOMContentLoaded', function () {
    var s = 256;
    // change from 200 pizzas to a calculation of #pizzas based on browser size
